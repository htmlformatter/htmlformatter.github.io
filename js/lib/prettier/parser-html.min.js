...
function _createForOfIteratorHelper(o) { if (typeof Symbol === "undefined" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (o = _unsupportedIterableToArray(o))) { var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e20) { throw _e20; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var it, normalCompletion = true, didErr = false, err; return { s: function s() { it = o[Symbol.iterator](); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e21) { didErr = true; err = _e21; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }
...
!function (e, t) {
  ...
  var s = function s(e) {
    var t = Object.keys(n).map(r).join("|"),
  ...
  var _CSS_DISPLAY_TAGS$CSS = {
    ...
    CSS_WHITE_SPACE_DEFAULT: "normal"
      ...
      Ue = _CSS_DISPLAY_TAGS$CSS.CSS_DISPLAY_TAGS,
      Be = _CSS_DISPLAY_TAGS$CSS.CSS_DISPLAY_DEFAULT,
      Fe = _CSS_DISPLAY_TAGS$CSS.CSS_WHITE_SPACE_TAGS,
      Ve = _CSS_DISPLAY_TAGS$CSS.CSS_WHITE_SPACE_DEFAULT,
      He = Ge(Ie);
  ...
  var ot = {
    ...
    countParents: function countParents(e) {
      ...
      for (var _n4 = e.stack.length - 1; _n4 >= 0; _n4--) {
        var _s3 = e.stack[_n4];
        _s3 && "object" == _typeof(_s3) && !Array.isArray(_s3) && t(_s3) && r++;
      }
      ...
      var t = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function (e) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            if (0 === _r2.length) continue;
            if (/\S/.test(_r2[0])) return 0;

            var _e2 = _r2.match(/^\s*/)[0].length;

            _r2.length !== _e2 && _e2 < t && (t = _e2);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
    ...
    forceBreakContent: function forceBreakContent(e) {
      return Ye(e) || "element" === e.type && 0 !== e.children.length && (["body", "script", "style"].includes(e.name) || e.children.some(function (e) {
        return function (e) {
          return e.children && e.children.some(function (e) {
            return "text" !== e.type;
          });
        }(e);
      })) || e.firstChild && e.firstChild === e.lastChild && Ze(e.firstChild) && (!e.lastChild.isTrailingSpaceSensitive || et(e.lastChild));
    },
    ...
    getNodeCssStyleDisplay: function getNodeCssStyleDisplay(e, t) {
      if (e.prev && "comment" === e.prev.type) {
        var _t2 = e.prev.value.match(/^\s*display:\s*([a-z]+)\s*$/);
    ...
    normalizeParts: function normalizeParts(e) {
      ...
      for (; 0 !== r.length;) {
        ...
        _e3 && ("concat" !== _e3.type ? 0 === t.length || "string" != typeof t[t.length - 1] || "string" != typeof _e3 ? t.push(_e3) : t.push(t.pop() + _e3) : r.unshift.apply(r, _toConsumableArray(_e3.parts)));
      }
  ...
  var pt = /*#__PURE__*/function () {
    function pt() {
      ...
      for (var _i3 = 0, _Object$keys2 = Object.keys(e); _i3 < _Object$keys2.length; _i3++) {
        var _t3 = _Object$keys2[_i3];
        var _r3 = e[_t3];
        _t3 in lt ? this._setNodes(_t3, _r3) : this[_t3] = _r3;
      }
    }
    ...
    _createClass(pt, [{
      ...
      value: function _setNodes(e, t) {
        t !== this[e] && (this[e] = function (e, t) {
          var r = e.map(function (e) {
            return e instanceof pt ? e.clone() : new pt(e);
          });
          var n = null,
              s = r[0],
              i = r[1] || null;
      ...
      value: function map(e) {
        ...
        for (var _r4 in lt) {
          ...
          if (_n5) {
            var _s4 = ut(_n5, function (t) {
              return t.map(e);
            });

            t !== _n5 && (t || (t = new pt()), t._setNodes(_r4, _s4));
          }
        }

        if (t) {
          for (var _e6 in this) {
            _e6 in lt || (t[_e6] = this[_e6]);
          }
  ...
  var mt = [[/^(\[if([^\]]*?)\]>)([\s\S]*?)<!\s*\[endif\]$/, function (e, t, r) {
    var _r6 = _slicedToArray(r, 4),
        n = _r6[1],
        s = _r6[2],
        i = _r6[3],
  ...
  var ft = {
    parseIeConditionalComment: function parseIeConditionalComment(e, t) {
      if (e.value) {
        var _r8;

        var _iterator3 = _createForOfIteratorHelper(mt),
            _step3;
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            if (_r8 = e.value.match(_n7)) return _s6(e, t, _r8);
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
    ...
    var r = /*#__PURE__*/function () {
      function r() {
        ...
        var _ref3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
            e = _ref3.closedByChildren,
            t = _ref3.implicitNamespacePrefix,
            _ref3$contentType = _ref3.contentType,
            _r9 = _ref3$contentType === void 0 ? gt.TagContentType.PARSABLE_DATA : _ref3$contentType,
            _ref3$closedByParent = _ref3.closedByParent,
            n = _ref3$closedByParent === void 0 ? !1 : _ref3$closedByParent,
            _ref3$isVoid = _ref3.isVoid,
            s = _ref3$isVoid === void 0 ? !1 : _ref3$isVoid,
            _ref3$ignoreFirstLf = _ref3.ignoreFirstLf,
            i = _ref3$ignoreFirstLf === void 0 ? !1 : _ref3$ignoreFirstLf;

        _classCallCheck(this, r);

        this.closedByChildren = {}, this.closedByParent = !1, this.canSelfClose = !1, e && e.length > 0 && e.forEach(function (e) {
          return _this.closedByChildren[e] = !0;
        }), this.isVoid = s, this.closedByParent = n || s, this.implicitNamespacePrefix = t || null, this.contentType = _r9, this.ignoreFirstLf = i;
      }
  ...
  var St = Le(function (e, t) {
    ...
    var r = /*#__PURE__*/function () {
      function r(e, t, _r10) {
        ...
        this.filePath = e, this.name = t, this.members = _r10;
      }
    ...
    t.StaticSymbolCache = /*#__PURE__*/function () {
      ...
      _createClass(_class, [{
        ...
        value: function get(e, t, n) {
          var s = (n = n || []).length ? ".".concat(n.join(".")) : "",
  ...
  var yt = Le(function (e, t) {
    ...
    function s(e, t, r) {
      return Array.isArray(e) ? t.visitArray(e, r) : "object" == _typeof(n = e) && null !== n && Object.getPrototypeOf(n) === a ? t.visitStringMap(e, r) : null == e || "string" == typeof e || "number" == typeof e || "boolean" == typeof e ? t.visitPrimitive(e, r) : t.visitOther(e, r);
      var n;
    }
    ...
    t.ValueTransformer = /*#__PURE__*/function () {
      ...
      then: function then(e, t) {
        return c(e) ? e.then(t) : t(e);
      },
      all: function all(e) {
        return e.some(c) ? Promise.all(e) : e;
      }
    }, t.error = function (e) {
    ...
    t.utf8Encode = function (e) {
      ...
      for (var _r11 = 0; _r11 < e.length; _r11++) {
        var _n8 = e.charCodeAt(_r11);

        if (_n8 >= 55296 && _n8 <= 56319 && e.length > _r11 + 1) {
          var _t4 = e.charCodeAt(_r11 + 1);

          _t4 >= 56320 && _t4 <= 57343 && (_r11++, _n8 = (_n8 - 55296 << 10) + _t4 - 56320 + 65536);
        }

        _n8 <= 127 ? t += String.fromCharCode(_n8) : _n8 <= 2047 ? t += String.fromCharCode(_n8 >> 6 & 31 | 192, 63 & _n8 | 128) : _n8 <= 65535 ? t += String.fromCharCode(_n8 >> 12 | 224, _n8 >> 6 & 63 | 128, 63 & _n8 | 128) : _n8 <= 2097151 && (t += String.fromCharCode(_n8 >> 18 & 7 | 240, _n8 >> 12 & 63 | 128, _n8 >> 6 & 63 | 128, 63 & _n8 | 128));
      }
  ...
  var bt = Le(function (e, t) {
    ...
    t.CompileTemplateMetadata = /*#__PURE__*/function () {
      function _class5(_ref5) {
        var e = _ref5.encapsulation,
            t = _ref5.template,
            r = _ref5.templateUrl,
            n = _ref5.htmlAst,
            s = _ref5.styles,
            i = _ref5.styleUrls,
            o = _ref5.externalStylesheets,
            a = _ref5.animations,
            p = _ref5.ngContentSelectors,
            u = _ref5.interpolation,
            h = _ref5.isInline,
            d = _ref5.preserveWhitespaces;
    ...
    var a = /*#__PURE__*/function () {
      _createClass(a, null, [{
        ...
        value: function create(_ref6) {
          var e = _ref6.isHost,
              ...
              s = _ref6.selector,
              i = _ref6.exportAs,
              o = _ref6.changeDetection,
              c = _ref6.inputs,
              l = _ref6.outputs,
              p = _ref6.host,
              u = _ref6.providers,
              h = _ref6.viewProviders,
              d = _ref6.queries,
              m = _ref6.guards,
              f = _ref6.viewQueries,
              g = _ref6.entryComponents,
              _ = _ref6.template,
              T = _ref6.componentViewType,
              S = _ref6.rendererType,
              y = _ref6.componentFactory;
          var b = {},
              C = {},
              E = {};
      ...
      function a(_ref7) {
        var e = _ref7.isHost,
            ...
            n = _ref7.selector,
            s = _ref7.exportAs,
            i = _ref7.changeDetection,
            o = _ref7.inputs,
            _a = _ref7.outputs,
            l = _ref7.hostListeners,
            p = _ref7.hostProperties,
            u = _ref7.hostAttributes,
            h = _ref7.providers,
            d = _ref7.viewProviders,
            m = _ref7.queries,
            f = _ref7.guards,
            g = _ref7.viewQueries,
            _ = _ref7.entryComponents,
            T = _ref7.template,
            S = _ref7.componentViewType,
            y = _ref7.rendererType,
            b = _ref7.componentFactory;

        _classCallCheck(this, a);

        this.isHost = !!e, this.type = t, this.isComponent = r, this.selector = n, this.exportAs = s, this.changeDetection = i, this.inputs = o, this.outputs = _a, this.hostListeners = l, this.hostProperties = p, this.hostAttributes = u, this.providers = c(h), this.viewProviders = c(d), this.queries = c(m), this.guards = f, this.viewQueries = c(g), this.entryComponents = c(_), this.template = T, this.componentViewType = S, this.rendererType = y, this.componentFactory = b;
      }
    ...
    t.CompileNgModuleMetadata = /*#__PURE__*/function () {
      function _class8(_ref9) {
        var e = _ref9.type,
            t = _ref9.providers,
            r = _ref9.declaredDirectives,
            n = _ref9.exportedDirectives,
            s = _ref9.declaredPipes,
            i = _ref9.exportedPipes,
            o = _ref9.entryComponents,
            a = _ref9.bootstrapComponents,
            l = _ref9.importedModules,
            p = _ref9.exportedModules,
            u = _ref9.schemas,
            h = _ref9.transitiveModule,
            d = _ref9.id;
    ...
    t.ProviderMeta = /*#__PURE__*/function () {
      function _class10(e, _ref10) {
        var t = _ref10.useClass,
            r = _ref10.useValue,
            n = _ref10.useExisting,
            s = _ref10.useFactory,
            i = _ref10.deps,
            o = _ref10.multi;
  ...
  var Ct = Le(function (e, t) {
    ...
    var r = /*#__PURE__*/function () {
      function r(e, t, _r12, n) {
        _classCallCheck(this, r);

        this.file = e, this.offset = t, this.line = _r12, this.col = n;
      }
      ...
      _createClass(r, [{
        ...
        value: function moveBy(e) {
          ...
          for (; s > 0 && e < 0;) {
            if (s--, e++, t.charCodeAt(s) == Tt.$LF) {
              ...
              var _e7 = t.substr(0, s - 1).lastIndexOf(String.fromCharCode(Tt.$LF));
          ...
          for (; s < n && e > 0;) {
            var _r13 = t.charCodeAt(s);

            s++, e--, _r13 == Tt.$LF ? (i++, o = 0) : o++;
          }
        ...
        value: function getContext(e, t) {
          ...
          if (null != n) {
            ...
            for (_i5 = 0, _o = 0; _i5 < e && _s7 < r.length - 1 && (_s7++, _i5++, "\n" != r[_s7] || ++_o != t);) {
              ;
            }

            return {
              before: r.substring(n, this.offset),
              after: r.substring(this.offset, _s7 + 1)
            };
          }
    ...
    t.ParseError = /*#__PURE__*/function () {
      function _class11(e, t) {
        var r = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : i.ERROR;
      ...
      var i = bt.identifierModuleUrl(t),
      ...
      var o = "in ".concat(e, " ").concat(t, " in ").concat(i),
          a = new n("", o);
      return new s(new r(a, -1, -1, -1), new r(a, -1, -1, -1));
    };
  });
    ...
    t.AstPath = /*#__PURE__*/function () {
      ...
      _createClass(_class12, [{
        ...
        value: function first(e) {
          for (var _t5 = this.path.length - 1; _t5 >= 0; _t5--) {
            var _r14 = this.path[_t5];
            if (_r14 instanceof e) return _r14;
          }
        }
      }, {
        key: "push",
  ...
  var vt = Le(function (e, t) {
    ...
    t.Text = /*#__PURE__*/function () {
      function _class13(e, t, r) {
    ...
    t.Expansion = /*#__PURE__*/function () {
      function _class15(e, t, r, n, s, i) {
    ...
    t.ExpansionCase = /*#__PURE__*/function () {
      function _class16(e, t, r, n, s) {
    ...
    t.Attribute = /*#__PURE__*/function () {
      function _class17(e, t, r) {
    ...
    var r = /*#__PURE__*/function () {
      function r(e, t, _r15, n) {
        ...
        this.name = e, this.attrs = t, this.children = _r15, this.sourceSpan = n, this.startSourceSpan = s, this.endSourceSpan = i, this.nameSpan = o, this.i18n = a;
      }
    ...
    t.Comment = /*#__PURE__*/function () {
      function _class18(e, t) {
    ...
    t.DocType = /*#__PURE__*/function () {
      function _class19(e, t) {
    ...
    t.RecursiveVisitor = s, t.findNode = function (e, t) {
      var i = [];
      return n(new ( /*#__PURE__*/function (_s8) {
        _inherits(_class20, _s8);

        var _super = _createSuper(_class20);
  ...
  var At = Le(function (e, t) {
    ...
    Object.defineProperty(t, "__esModule", {
      ...
      if (null != t) {
        ...
        for (var _r16 = 0; _r16 < t.length; _r16 += 1) {
          if ("string" != typeof t[_r16]) throw new Error("Expected '".concat(e, "' to be an array of strings."));
        }
      }
    };
    var r = [/^\s*$/, /[<>]/, /^[{}]$/, /&(#|[a-z])/i, /^\/\//];
    ...
    t.assertInterpolationSymbols = function (e, t) {
      ...
      if (null != t) {
        ...
        r.forEach(function (t) {
          if (t.test(_e8) || t.test(_n9)) throw new Error("['".concat(_e8, "', '").concat(_n9, "'] contains unusable interpolation symbol."));
        });
      }
    };
  });
  ...
  var kt = Le(function (e, t) {
    ...
    var i = /*#__PURE__*/function (_Ct$ParseError) {
      _inherits(i, _Ct$ParseError);
    ...
    t.TokenizeResult = o, t.tokenize = function (e, t, r) {
    ...
    function c(e) {
      var t = e === r.$EOF ? "EOF" : String.fromCharCode(e);
    ...
    var u = /*#__PURE__*/function () {
      function u(e, t, r) {
        ...
        this._getTagDefinition = t, this._currentTokenStart = null, this._currentTokenType = null, this._expansionCaseStack = [], this._inInterpolation = !1, this.tokens = [], this.errors = [], this._tokenizeIcu = r.tokenizeExpansionForms || !1, this._interpolationConfig = r.interpolationConfig || wt.DEFAULT_INTERPOLATION_CONFIG, this._leadingTriviaCodePoints = r.leadingTriviaChars && r.leadingTriviaChars.map(function (e) {
      ...
      _createClass(u, [{
        ...
        value: function tokenize() {
          for (; this._cursor.peek() !== r.$EOF;) {
            var _e9 = this._cursor.clone();

            try {
              if (this._attemptCharCode(r.$LT)) {
                if (this._attemptCharCode(r.$BANG)) this._attemptStr("[CDATA[") ? this._consumeCdata(_e9) : this._attemptStr("--") ? this._consumeComment(_e9) : this._attemptStrCaseInsensitive("doctype") ? this._consumeDocType(_e9) : this._consumeBogusComment(_e9);else if (this._attemptCharCode(r.$SLASH)) this._consumeTagClose(_e9);else {
                  var _t6 = this._cursor.clone();

                  this._attemptCharCode(r.$QUESTION) ? (this._cursor = _t6, this._consumeBogusComment(_e9)) : this._consumeTagOpen(_e9);
                }
          ...
          return this._beginToken(n.EOF), this._endToken([]), new o(function (e) {
            ...
            for (var _s9 = 0; _s9 < e.length; _s9++) {
              var _i6 = e[_s9];
              r && r.type == n.TEXT && _i6.type == n.TEXT ? (r.parts[0] += _i6.parts[0], r.sourceSpan.end = _i6.sourceSpan.end) : (r = _i6, t.push(r));
            }
        ...
        value: function _endToken(e) {
          ...
          var r = new s(this._currentTokenType, e, this._cursor.getSpan(this._currentTokenStart, this._leadingTriviaCodePoints));
        ...
        value: function _createError(e, t) {
          ...
          var r = new i(e, this._currentTokenType, t);
        ...
        value: function _attemptStr(e) {
          ...
          for (var _n10 = 0; _n10 < t; _n10++) {
            if (!this._attemptCharCode(e.charCodeAt(_n10))) return this._cursor = r, !1;
          }
        ...
        value: function _attemptStrCaseInsensitive(e) {
          for (var _t7 = 0; _t7 < e.length; _t7++) {
            if (!this._attemptCharCodeCaseInsensitive(e.charCodeAt(_t7))) return !1;
          }
        ...
        value: function _readChar(e) {
          ...
          {
            var _e10 = String.fromCodePoint(this._cursor.peek());

            return this._cursor.advance(), _e10;
          }
        }
      }, {
        key: "_decodeEntity",
        value: function _decodeEntity() {
          ...
          if (this._cursor.advance(), !this._attemptCharCode(r.$HASH)) {
            var _t8 = this._cursor.clone();

            if (this._attemptCharCodeUntilFn(f), this._cursor.peek() != r.$SEMICOLON) return this._cursor = _t8, "&";

            var _n11 = this._cursor.getChars(_t8);

            this._cursor.advance();

            var _s10 = gt.NAMED_ENTITIES[_n11];
            if (!_s10) throw this._createError(l(_n11), this._cursor.getSpan(e));
            return _s10;
          }

          {
            var _t9 = this._attemptCharCode(r.$x) || this._attemptCharCode(r.$X),
                _n12 = this._cursor.clone();
            ...
            var _s11 = this._cursor.getChars(_n12);

            this._cursor.advance();

            try {
              var _e11 = parseInt(_s11, _t9 ? 16 : 10);

              return String.fromCharCode(_e11);
            } catch (t) {
        ...
        value: function _consumeRawText(e, t) {
          ...
          for (;;) {
            var _n13 = this._cursor.clone(),
                _s12 = t();

            if (this._cursor = _n13, _s12) break;
        ...
        value: function _consumeComment(e) {
          ...
          this._beginToken(n.COMMENT_START, e), this._endToken([]), this._consumeRawText(!1, function () {
            return _this5._attemptStr("--\x3e");
          }), this._beginToken(n.COMMENT_END), this._requireStr("--\x3e"), this._endToken([]);
        }
      }, {
        ...
        value: function _consumeCdata(e) {
          ...
          this._beginToken(n.CDATA_START, e), this._endToken([]), this._consumeRawText(!1, function () {
        ...
        value: function _consumeDocType(e) {
          ...
          this._beginToken(n.DOC_TYPE_START, e), this._endToken([]), this._consumeRawText(!1, function () {
        ...
        value: function _consumePrefixAndName() {
          ...
          for (; this._cursor.peek() !== r.$COLON && !(((n = this._cursor.peek()) < r.$a || r.$z < n) && (n < r.$A || r.$Z < n) && (n < r.$0 || n > r.$9));) {
            this._cursor.advance();
          }
        ...
        value: function _consumeTagOpen(e) {
          ...
          var l = this._getTagDefinition(t).contentType;
        ...
        value: function _consumeRawTextWithTagClose(e, t, s) {
          var _this9 = this;

          this._consumeRawText(s, function () {
            return !!_this9._attemptCharCode(r.$LT) && !!_this9._attemptCharCode(r.$SLASH) && (_this9._attemptCharCodeUntilFn(h), !!_this9._attemptStrCaseInsensitive(e ? "".concat(e, ":").concat(t) : t) && (_this9._attemptCharCodeUntilFn(h), _this9._attemptCharCode(r.$GT)));
          });

          this._beginToken(n.TAG_CLOSE), this._requireCharCodeUntilFn(function (e) {
            return e === r.$GT;
          }, 3), this._cursor.advance(), this._endToken([e, t]);
        }
      }, {
        ...
        value: function _consumeAttributeValue() {
          ...
          if (this._cursor.peek() === r.$SQ || this._cursor.peek() === r.$DQ) {
            ...
            var _t10 = this._cursor.peek();

            this._cursor.advance(), this._endToken([String.fromCodePoint(_t10)]), this._beginToken(n.ATTR_VALUE);
            var _r17 = [];

            for (; this._cursor.peek() !== _t10;) {
              _r17.push(this._readChar(!0));
            }

            e = _r17.join(""), this._endToken([this._processCarriageReturns(e)]), this._beginToken(n.ATTR_QUOTE), this._cursor.advance(), this._endToken([String.fromCodePoint(_t10)]);
          } else {
            this._beginToken(n.ATTR_VALUE);

            var _t11 = this._cursor.clone();

            this._requireCharCodeUntilFn(d, 1), e = this._cursor.getChars(_t11), this._endToken([this._processCarriageReturns(e)]);
          }
        }
      }, {
        key: "_consumeTagOpenEnd",
        value: function _consumeTagOpenEnd() {
          var e = this._attemptCharCode(r.$SLASH) ? n.TAG_OPEN_END_VOID : n.TAG_OPEN_END;
        ...
        value: function _consumeTagClose(e) {
          if (this._beginToken(n.TAG_CLOSE, e), this._attemptCharCodeUntilFn(h), this._allowHtmComponentClosingTags && this._attemptCharCode(r.$SLASH)) this._attemptCharCodeUntilFn(h), this._requireCharCode(r.$GT), this._endToken([]);else {
            var _e12 = this._consumePrefixAndName();

            this._attemptCharCodeUntilFn(h), this._requireCharCode(r.$GT), this._endToken(_e12);
          }
        }
      }, {
        ...
        value: function _consumeExpansionCaseStart() {
          ...
          var e = this._readUntil(r.$LBRACE).trim();
        ...
        value: function isExpansionFormStart() {
          ...
          if (this._interpolationConfig) {
            var _e13 = this._cursor.clone(),
                _t12 = this._attemptStr(this._interpolationConfig.start);

            return this._cursor = _e13, !_t12;
          }
    ...
    var T = /*#__PURE__*/function (_ref11) {
      _inherits(T, _ref11);
      ...
      function T(e, t) {
        ...
        e instanceof T ? (_this10 = _super3.call(this, e), _this10.internalState = Object.assign({}, e.internalState)) : (_this10 = _super3.call(this, e, t), _this10.internalState = _this10.state);
      ...
      _createClass(T, [{
        key: "advance",
        value: function advance() {
          this.state = this.internalState, _get(_getPrototypeOf(T.prototype), "advance", this).call(this), this.processEscapeSequence();
        }
      }, {
        key: "init",
        value: function init() {
          _get(_getPrototypeOf(T.prototype), "init", this).call(this), this.processEscapeSequence();
        }
      }, {
        key: "clone",
        value: function clone() {
        ...
        value: function processEscapeSequence() {
          ...
          if (e() === r.$BACKSLASH) if (this.internalState = Object.assign({}, this.state), this.advanceState(this.internalState), e() === r.$n) this.state.peek = r.$LF;else if (e() === r.$r) this.state.peek = r.$CR;else if (e() === r.$v) this.state.peek = r.$VTAB;else if (e() === r.$t) this.state.peek = r.$TAB;else if (e() === r.$b) this.state.peek = r.$BSPACE;else if (e() === r.$f) this.state.peek = r.$FF;else if (e() === r.$u) {
            if (this.advanceState(this.internalState), e() === r.$LBRACE) {
              ...
              for (; e() !== r.$RBRACE;) {
                this.advanceState(this.internalState), _n14++;
              }

              this.state.peek = this.decodeHexDigits(_t13, _n14);
            } else {
              var _e14 = this.clone();

              this.advanceState(this.internalState), this.advanceState(this.internalState), this.advanceState(this.internalState), this.state.peek = this.decodeHexDigits(_e14, 4);
            }
          } else if (e() === r.$x) {
            this.advanceState(this.internalState);
            ...
            this.advanceState(this.internalState), this.state.peek = this.decodeHexDigits(_e15, 2);
          } else if (r.isOctalDigit(e())) {
            var _t14 = "",
                _n15 = 0,
                _s13 = this.clone();

            for (; r.isOctalDigit(e()) && _n15 < 3;) {
              _s13 = this.clone(), _t14 += String.fromCodePoint(e()), this.advanceState(this.internalState), _n15++;
            }

            this.state.peek = parseInt(_t14, 8), this.internalState = _s13.internalState;
  ...
  var Nt = Le(function (e, t) {
    ...
    var r = /*#__PURE__*/function (_Ct$ParseError2) {
      _inherits(r, _Ct$ParseError2);
      ...
      function r(e, t, _r18) {
        ...
        _this12 = _super4.call(this, t, _r18), _this12.elementName = e;
        return _this12;
      }
    ...
    t.Parser = /*#__PURE__*/function () {
      ...
      _createClass(_class21, [{
        ...
        value: function parse(e, t, r) {
          ...
          var o = i ? this.getTagDefinition : function (e) {
            return _this13.getTagDefinition(e.toLowerCase());
          },
    ...
    var s = /*#__PURE__*/function () {
      ...
      _createClass(s, [{
        ...
        key: "_consumeComment",
        value: function _consumeComment(e) {
          var t = this._advanceIf(kt.TokenType.RAW_TEXT),
        ...
        value: function _consumeExpansion(e) {
          ...
          for (; this._peek.type === kt.TokenType.EXPANSION_CASE_VALUE;) {
            var _e16 = this._parseExpansionCase();
          ...
          var i = new Ct.ParseSourceSpan(e.sourceSpan.start, this._peek.sourceSpan.end);
        ...
        value: function _parseExpansionCase() {
          ...
          var o = new s(n, this.getTagDefinition, this.canSelfClose, this.allowHtmComponentClosingTags, this.isTagNameCaseSensitive).build();
          if (o.errors.length > 0) return this._errors = this._errors.concat(o.errors), null;
          var a = new Ct.ParseSourceSpan(e.sourceSpan.start, i.sourceSpan.end),
        ...
        value: function _getText(e) {
          ...
          if (t.length > 0 && "\n" == t[0]) {
            var _e17 = this._getParentElement();

            null != _e17 && 0 == _e17.children.length && this.getTagDefinition(_e17.name).ignoreFirstLf && (t = t.substring(1));
          }
        ...
        value: function _consumeStartTag(e) {
          ...
          for (; this._peek.type === kt.TokenType.ATTR_NAME;) {
            s.push(this._consumeAttr(this._advance()));
          }

          var i = this._getElementFullName(t, n, this._getParentElement());
          ...
          if (this._peek.type === kt.TokenType.TAG_OPEN_END_VOID) {
            ...
            var _t15 = this.getTagDefinition(i);

            this.canSelfClose || _t15.canSelfClose || null !== gt.getNsPrefix(i) || _t15.isVoid || this._errors.push(r.create(i, e.sourceSpan, 'Only void and foreign elements can be self closed "'.concat(e.parts[1], '"')));
          } else this._peek.type === kt.TokenType.TAG_OPEN_END && (this._advance(), o = !1);

          var a = this._peek.sourceSpan.start,
        ...
        value: function _consumeEndTag(e) {
          ...
          if (this._getParentElement() && (this._getParentElement().endSourceSpan = e.sourceSpan), t && this.getTagDefinition(t).isVoid) this._errors.push(r.create(t, e.sourceSpan, 'Void elements do not have end tags "'.concat(e.parts[1], '"')));else if (!this._popElement(t)) {
            var _n16 = 'Unexpected closing tag "'.concat(t, '". It may happen when the tag has already been closed by another tag. For more info see https://www.w3.org/TR/html5/syntax.html#closing-elements-that-have-implied-end-tags');

            this._errors.push(r.create(t, e.sourceSpan, _n16));
          }
        }
      }, {
        key: "_popElement",
        value: function _popElement(e) {
          for (var _t16 = this._elementStack.length - 1; _t16 >= 0; _t16--) {
            var _r19 = this._elementStack[_t16];
            if (!e || (gt.getNsPrefix(_r19.name) ? _r19.name == e : _r19.name.toLowerCase() == e.toLowerCase())) return this._elementStack.splice(_t16, this._elementStack.length - _t16), !0;
            if (!this.getTagDefinition(_r19.name).closedByParent) return !1;
          }
        ...
        value: function _consumeAttr(e) {
          var t = gt.mergeNsAndName(e.parts[0], e.parts[1]);
          var r = e.sourceSpan.end,
              n = "",
              s = void 0,
              i = void 0;
          ...
          if (this._peek.type === kt.TokenType.ATTR_VALUE) {
            var _e18 = this._advance();

            n = _e18.parts[0], r = _e18.sourceSpan.end, s = _e18.sourceSpan;
          }
        ...
        value: function _getParentElementSkippingContainers() {
          ...
          for (var _t17 = this._elementStack.length - 1; _t17 >= 0; _t17--) {
            if (!gt.isNgContainer(this._elementStack[_t17].name)) return {
              parent: this._elementStack[_t17],
              container: e
            };
            e = this._elementStack[_t17];
          }
  ...
  var xt = Le(function (e, t) {
    ...
    var n = /*#__PURE__*/function (_Nt$Parser) {
      _inherits(n, _Nt$Parser);
      ...
      function n() {
        ...
        return _super5.call(this, _t.getHtmlTagDefinition);
      }
      ...
      _createClass(n, [{
        ...
        value: function parse(e, t, r) {
          ...
          //var n = "angular-html-parser";
          console.log(n.prototype);
          return _get(_getPrototypeOf(n.prototype), "parse", this).call(this, e, t, r, n);
        }
      }]);
  ...
  var Pt = Le(function (e, t) {
    ...
    t.parse = function (e) {
      var _ref12 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
          _ref12$canSelfClose = _ref12.canSelfClose,
          t = _ref12$canSelfClose === void 0 ? !1 : _ref12$canSelfClose,
          _ref12$allowHtmCompon = _ref12.allowHtmComponentClosingTags,
          n = _ref12$allowHtmCompon === void 0 ? !1 : _ref12$allowHtmCompon,
          _ref12$isTagNameCaseS = _ref12.isTagNameCaseSensitive,
          s = _ref12$isTagNameCaseS === void 0 ? !1 : _ref12$isTagNameCaseS;
  ...
  qe(Pt);
  Pt.parse;
  var Dt = ot.HTML_ELEMENT_ATTRIBUTES,
      Rt = ot.HTML_TAGS,
      Ot = ot.isUnknownNamespace,
      qt = at.hasPragma,
      Lt = dt.Node,
      $t = ft.parseIeConditionalComment;

  function It(e, _ref13) {
    var t = _ref13.recognizeSelfClosing,
        r = _ref13.normalizeTagName,
        n = _ref13.normalizeAttributeName,
        s = _ref13.allowHtmComponentClosingTags,
        i = _ref13.isTagNameCaseSensitive;

    var o = Pt,
        a = vt.RecursiveVisitor,
        c = vt.visitAll,
        l = vt.Attribute,
        p = vt.CDATA,
        u = vt.Comment,
        ...
        d = vt.Element,
        m = vt.Text,
        f = Ct.ParseSourceSpan,
        g = _t.getHtmlTagDefinition,
        _o$parse = o.parse(e, {
      canSelfClose: t,
      allowHtmComponentClosingTags: s,
      isTagNameCaseSensitive: i
    }),
        _ = _o$parse.rootNodes,
        T = _o$parse.errors;
    ...
    if (0 !== T.length) {
      var _T$ = T[0],
          _e19 = _T$.msg,
          _t18 = _T$.span,
          _t18$start = _t18.start,
          _r20 = _t18$start.line,
          _n18 = _t18$start.col;
      throw ct(_e19, {
        start: {
          line: _r20 + 1,
    ...
    return c(new ( /*#__PURE__*/function (_a2) {
      _inherits(_class22, _a2);

      var _super6 = _createSuper(_class22);
      ...
      _createClass(_class22, [{
        ...
        value: function visit(e) {
          (function (e) {
            ...
            e instanceof d ? (S(e), e.attrs.forEach(function (e) {
            ...
            if (e instanceof d) {
              var _t19 = g(i ? e.name : e.name.toLowerCase());

              !e.namespace || e.namespace === _t19.implicitNamespacePrefix || Ot(e) ? e.tagDefinition = _t19 : e.tagDefinition = g("");
            }
          }(e), function (e) {
            if (e instanceof d && (!r || e.namespace && e.namespace !== e.tagDefinition.implicitNamespacePrefix && !Ot(e) || (e.name = y(e.name, function (e) {
              return e in Rt;
            })), n)) {
              var _t20 = Dt[e.name] || Object.create(null);

              e.attrs.forEach(function (r) {
                r.namespace || (r.name = y(r.name, function (r) {
                  return e.name in Dt && (r in Dt["*"] || r in _t20);
                }));
              });
            }
          }(e), function (e) {
  ...
  function Bt() {
    var _ref14 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        _ref14$recognizeSelfC = _ref14.recognizeSelfClosing,
        e = _ref14$recognizeSelfC === void 0 ? !1 : _ref14$recognizeSelfC,
        _ref14$normalizeTagNa = _ref14.normalizeTagName,
        t = _ref14$normalizeTagNa === void 0 ? !1 : _ref14$normalizeTagNa,
        _ref14$normalizeAttri = _ref14.normalizeAttributeName,
        r = _ref14$normalizeAttri === void 0 ? !1 : _ref14$normalizeAttri,
        _ref14$allowHtmCompon = _ref14.allowHtmComponentClosingTags,
        n = _ref14$allowHtmCompon === void 0 ? !1 : _ref14$allowHtmCompon,
        _ref14$isTagNameCaseS = _ref14.isTagNameCaseSensitive,
        i = _ref14$isTagNameCaseS === void 0 ? !1 : _ref14$isTagNameCaseS;

    return {
      parse: function parse(o, a, c) {
